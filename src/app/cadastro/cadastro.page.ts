...
export class CadastroPage implements OnInit {
  ...
  salvarSecundario(){
    ...
    let dados = {
      requisicao: "salvamentoSecundario",
    ...
    this.provider.requisicaoPost(dados,"/cadastro.php").subscribe((data)=>{
      console.log(data);
      if(data['situacao'] == 200){
        this.loadingController.dismiss();
        this.presentAlert("Paciente salvo com sucesso");
